...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        //devo leggere le immagini nel database ed evidenziarle nella literal
        FOTO m = new FOTO();
        DataTable DT = new DataTable();
        DT = m.ShowPhoto(); //ci ritroviamo così tutte le immagini nella tabella 

        ////impostiamo così il gestore così potra costruire l'immagine (?)
        //string chiave = DT.Rows[0]["chiave"].ToString();
        //lit.Text = "<img src='gestore.ashx?c=" + chiave + "' />";
        //così vediamo una sola immagine ma noi vogliamo vederle tutte
